...
Ts = [10, 0, 4, -2]
Ss = [30, 0, 0, 30]
rhos = [Q(1023.0511189339445, 'kg_w/m3_w'),
        Q(999.842594, 'kg_w/m3_w'),
        Q(999.974958175956, 'kg_w/m3_w'),
        Q(1024.1185428978292, 'kg_w/m3_w')]
drho_dTs = [Q(-0.16031187007507228, 'kg_w/m3_w/K'),
            Q(0.06793952, 'kg_w/m3_w/K'),
            Q(-0.0002930867430400018, 'kg_w/m3_w/K'),
            Q(-0.00872035575824636, 'kg_w/m3_w/K')]
drho_dSs = [Q(0.7794654690372231, 'kg_w/m3_w/permille'),
            Q(0.824493, 'kg_w/m3_w/permille'),
            Q(0.80930500832, 'kg_w/m3_w/permille'),
            Q(0.8132059110359867, 'kg_w/m3_w/permille')]
