...
def test_calc_solcoeff_all_floats():
    ...
    assert_allclose(calc_solcoeff(['He', 'Ne'], 5, 30, 0.98, solcoeff_type='Kvv', ret_quant=True), Q([7.944513869340828e-08, 9.944619449222586e-08], 'Pa^-1'))
...
def test_calc_solcoeff_all_quants_default_units():
    ...
    assert_allclose(calc_solcoeff(['He', 'Ne'], Q(5, 'degC'), Q(30, 'permille'), Q(0.98, 'atm'), ret_quant=True), Q([0.00819712956000799, 0.01026083349981193], 'dimensionless'))
...
def test_calc_solcoeff_all_quants_custom_units():
    ...
    assert_allclose(calc_solcoeff(['He', 'Ne'], Q(278.15, 'K'), Q(3, 'percent'), Q(744.799893891099, 'mmHg'), ret_quant=True), Q([0.00819712956000799, 0.01026083349981193], 'dimensionless'))
...
def test_calc_solcoeff_mixed():
    ...
    assert_allclose(calc_solcoeff(['He', 'Ne'], Q(278.15, 'K'), Q(3, 'percent'), 0.98, ret_quant=True), Q([0.00819712956000799, 0.01026083349981193], 'dimensionless'))
